                    ...
                    <li class="nav-item dropdown" id="navbarNav">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="idn.png" height="40px"> <b class="caret"></b></a>
                            <ul class="dropdown-menu multi-level">
                                <li><a href="topup_pubg.php"><img src="idn.png" height="25px">&nbsp;Indonesia</a></li>
                                <li><a href="topup_pubg_eng.php"><img src="eng.png" height="25px">&nbsp;English (US)</a></li>
                                <li class="divider"></li>
                                </li>
                            </ul>
                    </li>
	...
	<form id="pesan_sekarang" method="POST">
		...
		<div class="col-10 offset-1">
			...
			&emsp; <a href="index.html" type="submit" class="previous round" >&#10094;</a>
				...
				<br>
				<br>
					<img src="pubg_poster.png" width="400px" alt="poster">
					<br>
					<br>
					<h3><strong>PUBG</strong></h3>
					<p><strong>Top up UC PUBG hanya dalam hitungan detik! Cukup masukan User ID PUBG Anda, pilih jumlah UC yang Anda inginkan, dan selesaikan pembayaran. UC PUBG akan secara langsung ditambahkan ke akun PUBG Anda.</strong></p>
					<a href="pubg_tutor.html" class='tombol'>Tutorial</a>
				</div>
				...
				<div id="card1">
					<div id="card-content1">
						...
						<input type="radio" name="diamond" id="diamond" value="263"> 263 UC &ensp; &nbsp; Rp.48.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="525"> 525 UC &ensp; Rp.95.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="788"> 788 UC &ensp; Rp.143.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="1050"> 1050 UC &ensp; Rp.180.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="1375"> 1365 UC &ensp; Rp.225.000,-
