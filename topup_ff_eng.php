		...
		<div class="col-10 offset-1">
			...
			&emsp; <a href="index.html" type="submit" class="previous round" >&#10094;</a>
				...
				<br>
					...
					<p><strong>Top up Free Fire diamonds in just seconds! Just enter your Free Fire User ID, select the number of Diamonds you want, and complete the payment. Free Fire Diamonds will be directly added to your Free Fire account.</strong></p>
					<br>
					<a href="ff_tutor_eng.html" class="tombol">Tutorials</a>
				</div>
                ...
                <div id="card1">
					<div id="card-content1">
						...
						<input type="radio" name="diamond" id="diamond" value="70"> 70 Diamonds &ensp; &nbsp; $0.89
						<br>
						<input type="radio" name="diamond" id="diamond" value="100"> 100 Diamonds &ensp; $1.03
						<br>
						<input type="radio" name="diamond" id="diamond" value="140"> 140 Diamonds &ensp; $1.44
						<br>
						<input type="radio" name="diamond" id="diamond" value="160"> 514 Diamonds &ensp; $1.72
						<br>
						<input type="radio" name="diamond" id="diamond" value="210"> 706 Diamonds &ensp; $2.06
