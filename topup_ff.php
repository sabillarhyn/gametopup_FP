                    ...
                    <li class="nav-item dropdown" id="navbarNav">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="idn.png" height="40px"> <b class="caret"></b></a>
                            <ul class="dropdown-menu multi-level">
                                <li><a href="topup_ff.php"><img src="idn.png" height="25px">&nbsp;Indonesia</a></li>
                                <li><a href="topup_ff_eng.php"><img src="eng.png" height="25px">&nbsp;English (US)</a></li>
                                <li class="divider"></li>
                                </li>
                            </ul>
                    </li>
	...
	<form id="pesan_sekarang" method="POST">
		...
		<div class="col-10 offset-1">
			...
			&emsp; <a href="index.html" type="submit" class="previous round" >&#10094;</a>
				...
				<br>
				<br>
					<img src="ff_poster.png" width="400px" alt="poster">
					<br>
					<br>
					<h3><strong>Free Fire</strong></h3>
					<p><strong>Top up diamond Free Fire hanya dalam hitungan detik! Cukup masukan User ID Free Fire Anda, pilih jumlah Diamond yang Anda inginkan, dan selesaikan pembayaran. Diamond Free Fire akan secara langsung ditambahkan ke akun Free Fire Anda.</strong></p>
					<br>
					<a href="ff_tutor.html" class='tombol'>Tutorial</a>
				</div>
				...
				<div id="card1">
					<div id="card-content1">
						...
						<input type="radio" name="diamond" id="diamond" value="70"> 70 Diamonds &ensp; &nbsp; Rp.13.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="100"> 100 Diamonds &ensp; Rp.15.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="140"> 140 Diamonds &ensp; Rp.21.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="160"> 514 Diamonds &ensp; Rp.25.000,-
						<br>
						<input type="radio" name="diamond" id="diamond" value="210"> 706 Diamonds &ensp; Rp.30.000,-
